...
public class WrapperEx2 {
	public static void main(String[] args) {
		...
		char c1='4', c2='F';
		if(Character.isDigit(c1)) // if문 한줄짜리는 {}생략 가능하다.
		...
		System.out.println(Integer.toString(200));//toString()은 정수를 문자형으로 변환해줌
		...
		System.out.println(Boolean.toString(b));//boolean형을 true를 문자열 "true"로 변환
