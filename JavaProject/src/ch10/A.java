...
//static method에서는 static 안의 로컬변수(일반변수)나 static으로 정의된 멤버 변수만 사용가능
...
public class A {
	...
	public static void main(String[] args) {
		...
		//System.out.println(name); //non-static멤버변수는 static 메소드 안에서는 바로 쓸 수 없다.
		
		aa.print();
		//print(); //non-static 멤버는 반드시 객체 생성 이후에나 사용 가능하다.
